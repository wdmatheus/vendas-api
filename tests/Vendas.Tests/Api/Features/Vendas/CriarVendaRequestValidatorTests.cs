...
public class CriarVendaRequestValidatorTests
{
    ...
    {
        // Arrange
        var criarVendaRequest = RequestsFakerFactory.BuildCriarVendaRequest(1) with { Numero = numero };

        // Act
        var result = new CriarVendaRequestValidator().Validate(criarVendaRequest);
    ...
    {
        // Arrange
        var criarVendaRequest = RequestsFakerFactory.BuildCriarVendaRequest(1) with { IdExterno = Guid.Empty };
    ...
    {
        // Arrange
        var criarVendaRequest = RequestsFakerFactory.BuildCriarVendaRequest(1) with { Filial = null! };
    ...
    {
        // Arrange
        var criarVendaRequest = RequestsFakerFactory.BuildCriarVendaRequest(1) with { Cliente = null! };
    ...
    {
        // Arrange
        var criarVendaRequest = RequestsFakerFactory.BuildCriarVendaRequest(1) ;
